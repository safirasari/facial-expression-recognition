...
class CNN_V2(nn.Module):
    def __init__(self):
        ...
        self.conv_layer = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=32, kernel_size=2, padding=0),
            nn.BatchNorm2d(32),
            nn.LeakyReLU(inplace=True),
            nn.Conv2d(in_channels=32, out_channels=32, kernel_size=2, padding=0),
            nn.BatchNorm2d(32),
            nn.LeakyReLU(inplace=True),
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        if best_val_loss is None or val_loss < best_val_loss:
            ...
            best_epoch = epoch + 1
            torch.save(modelA.state_dict(), "./models/best_v2.pt")
